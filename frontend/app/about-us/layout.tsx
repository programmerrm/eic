...
const fetchSeoTag = async () => {
  const res = await getFetchData('/about/seo-tag/');
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    // Basic Meta
    title: seo?.title || "Eic - About Page",
    ...
    // Canonical
    alternates: {
      canonical: seo?.canonical_url || "https://eic.com.bd/about-us",
    },
    ...
    metadataBase: new URL(seo?.canonical_url || "https://eic.com.bd/about-us"),
    other: {
