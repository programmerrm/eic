...
import BannerImg from "../../public/images/globe-blog-bg.svg";
        ...
        >
            <div className="container">
                <div className="w-full max-w-[616px] mx-auto text-center">
                    <h2>
                        Browse Our Latest Insights on{" "}
                        <span className="text-blue">Cybersecurity</span>
                    </h2>
                </div>

                <div
                    id="BrowserLatest"
                    className="grid sm:grid-cols-2 md:grid-cols-3 py-6 md:py-12 gap-5 lg:gap-9"
                >
                    {blogsItem.results.data.slice(0, 3).map((item: any) => {
                        ...
                        return (
                            <div className="items6" key={item.id}>
