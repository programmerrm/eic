    ...
    return (
        <section className=" pb-12 md:pb-[100px] relative compliance-bg">
            <div className="container">
                {complianceTitleData && (
                    <div className="flex flex-col lg:flex-row justify-between mb-10 md:mb-20 gap-5">
                ...
                {complianceItemData && (
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {complianceItemData?.map((item: any) => {
                            return (
                                <div
                                    className="p-4 md:p-8 bg-white border border-[#E6E7EB] rounded-[10px] transition-all hover:shadow-[25px_36px_18px_rgba(0,0,0,0.01),14px_20px_15px_rgba(0,0,0,0.05),6px_9px_11px_rgba(0,0,0,0.09),2px_2px_6px_rgba(0,0,0,0.1)]" key={item.id}>
